...
BUCKET_NAME = 'NOT_SET'
BUCKET_NAME_PREFIX = 'enriched_news/'
S3_ENDPOINT_URL = 'http://localhost:4566'
REGION_NAME = 'us-east-1'

LOCAL_DIRECTORY_PATH = 'NOT_SET'
...
def upload_directory_to_s3(local_dir_path, bucket):
    ...
    for root, _, files in os.walk(local_dir_path):
        for filename in files:
            ...
            # Determine the S3 key by removing the local base path
    ...
    print(f"\n Upload completed. Total files uploaded: {total_files}")
    print(f"Verify at: {S3_ENDPOINT_URL}/{bucket}/")
